  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Home Assistant Examples', link: 'home-assistant-examples', base: '/guide/firmware/' },
        { text: 'Entities', link: 'entities', base: '/reference/' },
        { text: 'Alternative Firmware', link: 'custom-firmware', base: '/guide/firmware/' }
      ]
    },
    {
      text: 'Automations',
